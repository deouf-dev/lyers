module.exports = {
     ...
     async run(client, interaction, guildData){
        const spammer = require("../../events/antiraid/antimasskick").spammer;
         ...
         if(target.roles.highest.position >= interaction.member.roles.highest.position) return interaction.reply({content: "Vous ne pouvez pas ex^pulser cette utilisateur car il possède un plusieurs rôle au-dessus de vous", ephemeral: true})
